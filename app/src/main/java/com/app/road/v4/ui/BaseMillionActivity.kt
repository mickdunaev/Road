...
import com.app.road.activity.BaseLenaActivity
import com.app.road.activity.HelloActivity
import com.app.road.activity.MainActivity
import com.app.road.activity.TestLenaActivity
...
class BaseMillionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_base_million)
    ...
    private fun setNotify(notify: ArrayList<String>){
        ...
        Log.d("Mikhael", "message будильник на BaseMillionActivity ${textNotify(at, mils)}")
        intent.putExtra("course","million")
    ...
    private fun baseSelect(){
        supportFragmentManager.beginTransaction()
            .replace(R.id.fragment, MillionFragment::class.java, null)
